...
export default function WhatsAppButton() {
  ...
  const href = `https://wa.me/33624542995?text=${MESSAGES[lang]}`
  ...
  return (
    <a
      ...
      onClick={() => trackEvent('whatsapp_click', { source: 'floating_button', lang })}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] text-white shadow-xl hover:bg-[#20c05e] transition-colors px-4 py-3 rounded-full group md:bottom-8 md:right-8"
    ...
    >
      ...
      <span className="font-sans text-xs tracking-widest uppercase hidden sm:inline whitespace-nowrap">
        {LABELS[lang]}
      </span>
    </a>
  )
