...
const ARTICLES: Record<Lang, Record<string, ArticleContent>> = {
  fr: {
    ...
    'ou-diner-noto': {
      ...
      body: [
        { heading: 'Le granita du matin', text: "[À compléter avec la meilleure granita de Noto — à confirmer]" },
        { heading: 'Déjeuner léger', text: "[À compléter — arancini, sandwich au panino, ou tavola calda locale — à confirmer]" },
        { heading: 'Dîner en terrasse', text: "[À compléter — restaurant avec vue sur le Duomo ou les ruelles baroques — à confirmer]" },
        { heading: 'La table gastronomique', text: "[À compléter — le restaurant le plus recommandé pour une grande occasion à Noto — à confirmer]" },
        { heading: 'Les glaces et douceurs', text: "[À compléter — meilleure pasticceria et glacerie — à confirmer]" },
      ],
      related_title: 'Noto et les environs',
      related_link: 'Noto et les environs →',
      related_slug: 'noto',
    },
  },
  en: {
    ...
    'where-to-eat-noto': {
      ...
      body: [
        { heading: 'Morning granita', text: "[To complete with Noto's best granita — to confirm]" },
        { heading: 'Light lunch', text: "[To complete — arancini, panino sandwich, or local tavola calda — to confirm]" },
        { heading: 'Dinner on a terrace', text: "[To complete — restaurant with a view of the Duomo or Baroque lanes — to confirm]" },
        { heading: 'The gastronomic table', text: "[To complete — the most recommended restaurant for a special occasion in Noto — to confirm]" },
        { heading: 'Sweets and ice cream', text: "[To complete — best pasticceria and gelateria — to confirm]" },
      ],
      related_title: 'Noto & surroundings',
      related_link: 'Noto & surroundings →',
      related_slug: 'noto',
    },
  },
  it: {
    ...
    'dove-mangiare-noto': {
      ...
      body: [
        { heading: 'La granita del mattino', text: "[Da completare con la migliore granita di Noto — da confermare]" },
        { heading: 'Pranzo leggero', text: "[Da completare — arancini, panino, o tavola calda locale — da confermare]" },
        { heading: 'Cena in terrazza', text: "[Da completare — ristorante con vista sul Duomo o sui vicoli barocchi — da confermare]" },
        { heading: 'Il ristorante gastronomico', text: "[Da completare — il ristorante più consigliato per un'occasione speciale a Noto — da confermare]" },
        { heading: 'Dolci e gelati', text: "[Da completare — migliore pasticceria e gelateria — da confermare]" },
      ],
      related_title: 'Noto e dintorni',
      related_link: 'Noto e dintorni →',
      related_slug: 'noto',
    },
  },
}
