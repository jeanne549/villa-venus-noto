...
const C = {
  fr: {
    ...
    distances: [
      ...
      { place: 'Spiagge di San Lorenzo', dist: '22 km · 28 min' },
      { place: 'Syracuse / Ortygie', dist: '30 km · 35 min' },
      { place: 'Modica', dist: '38 km · 40 min' },
  ...
  en: {
    ...
    distances: [
      ...
      { place: 'Marzamemi', dist: '20 km · 22 min' },
      { place: 'San Lorenzo beaches', dist: '22 km · 28 min' },
  ...
  de: {
    ...
    distances: [
      ...
      { place: 'Marzamemi', dist: '20 km · 22 Min.' },
      { place: 'Strände San Lorenzo', dist: '22 km · 28 Min.' },
