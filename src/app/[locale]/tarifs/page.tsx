...
const CONTENT = {
  fr: {
    ...
    conditions: ['Acompte : 30 % à la réservation', 'Solde : intégralité due le jour de l\'arrivée', 'Annulation : remboursement de l\'acompte (frais de dossier déduits) si annulation avant 60 jours · acompte non remboursable en deçà de 60 jours', 'Taxe de séjour communale · 3 € / personne / nuit · réglée sur place'],
  ...
  en: {
    ...
    conditions: ['Deposit: 30% at booking', 'Balance: full amount due on arrival', 'Cancellation: deposit refunded (admin fees deducted) if cancelled more than 60 days ahead · deposit non-refundable within 60 days', 'Local tourist tax · €3 / person / night · payable on site'],
  ...
  it: {
    ...
    conditions: ['Caparra: 30% alla prenotazione', 'Saldo: importo totale dovuto il giorno dell\'arrivo', 'Cancellazione: caparra rimborsata (meno le spese di gestione) per cancellazioni oltre 60 giorni prima · non rimborsabile entro 60 giorni', 'Tassa di soggiorno comunale · 3 € / persona / notte · pagata in loco'],
