  ...
  fr: [
    {
      ...
      items: [
        ...
        { q: 'Comment se passe le paiement ?', a: "Un acompte de 30 % est demandé à la réservation. Le solde est dû en intégralité le jour de l'arrivée." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Les animaux sont-ils acceptés ?', a: "Non, les animaux ne sont pas acceptés à la villa. Pour toute situation particulière, contactez-nous avant de réserver." },
    ...
    },
    {
      cat: 'Les environs',
      items: [
        { q: 'Y a-t-il un supermarché à proximité ?', a: "Noto (5 km) dispose de plusieurs supermarchés et d'un marché hebdomadaire. Des courses peuvent également être commandées depuis Noto." },
  ...
  en: [
    {
      ...
      items: [
        ...
        { q: 'How does payment work?', a: "A 30% deposit is required at booking. The full balance is due on the day of arrival." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Are pets allowed?', a: "No, pets are not accepted at the villa. For any specific situation, please contact us before booking." },
    ...
    },
    {
      ...
      items: [
        { q: 'Is there a supermarket nearby?', a: "Noto (5 km) has several supermarkets and a weekly market. Groceries can also be ordered from Noto." },
  ...
  it: [
    {
      ...
      items: [
        ...
        { q: 'Come funziona il pagamento?', a: "Una caparra del 30% è richiesta alla prenotazione. Il saldo completo è dovuto il giorno dell'arrivo." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Gli animali sono accettati?', a: "No, gli animali non sono accettati alla villa. Per qualsiasi situazione particolare, contattateci prima di prenotare." },
    ...
    },
    {
      cat: 'I dintorni',
      items: [
        { q: "C'è un supermercato nelle vicinanze?", a: "Noto (5 km) ha diversi supermercati e un mercato settimanale. È possibile ordinare la spesa anche da Noto." },
