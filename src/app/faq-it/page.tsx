    ...
    <>
      ...
      <div className="min-h-screen bg-cream">
        ...
        <main className="max-w-4xl mx-auto px-6 py-16">
          <p className="font-sans text-xs tracking-[0.3em] uppercase text-gold-text mb-4">Domande frequenti</p>
          ...
          <div className="mt-16 p-8 bg-navy text-white">
            ...
            <Link href="/it#contact" className="inline-block font-sans text-xs tracking-[0.2em] uppercase border border-gold text-gold-text px-6 py-3 hover:bg-gold hover:text-navy transition-colors">
              Contattaci
            </Link>
          </div>
        </main>
